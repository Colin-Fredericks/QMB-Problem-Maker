function [answers,correctness,path_str,file_name,explanations] = data71()
% Function DATA71 - QMB problem data71
%
%   [answers,correctness,explanations,path_str,file_name] = data71()
%       Generates the answers for QMB problem data71. 
%
%
...
wrong_explanations = {['No. Matlab does not search folders recursively. You would need to change your current directory to the lowest level folder, i.e. "' path_str '"'], ...
                      ...
                      'No. This will create a string variable that has the full file name. It will not load the data'};
