...
right_answers = {['$myImage = imread(''' path_str '/' file_name ''');/$'], ...
                 ['Change directory to "' path_str '"<br/> $myImage = imread(''' file_name ''');/$'], ...
                 ['Add "' path_str '" to the path<br/> $myImage = imread(''' file_name ''');/$'], ...
                 ['Copy "' file_name '" to the current directory<br/> $myImage = imread(''' file_name ''');/$'], ...
    };
...
wrong_answers = {['Change directory to "' root '"<br/> $myImage = imread(''' file_name ''');/$'], ...
                 ['Add "' root '" to the path<br/> $myImage = imread(''' file_name ''');/$'], ...
                 ['$myImage = imread(''' file_name ''');/$'], ...
