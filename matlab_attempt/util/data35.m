function [correct,incorrect,problem_values] = data35()
% function data35 - Generate answers for QMB problem data35
%
%   [correct,incorrect,problem_values] = data35()

% Pikc a a size to ask about and a wrong size for wrong answers
ask_size = randi([3 7],1);
other_size = ask_size + randsample([-1 1],1);

% Choices for argument of rand function
...
displays = {['$$' mimic_array_output(rand(1,ask_size)) '/$$'], ...
            ['$$' mimic_array_output(rand(ask_size,1)) '/$$'], ...
            ['$$' mimic_array_output(rand(ask_size)) '/$$']};

% Display of wrong arrays
other_displays = {['$$' mimic_array_output(rand(1,other_size)) '/$$'], ...
            ['$$' mimic_array_output(rand(other_size,1)) '/$$'], ...
            ['$$' mimic_array_output(rand(other_size)) '/$$']};
