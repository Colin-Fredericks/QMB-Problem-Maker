...
choices = {'This code has no mistakes', ...
            'The first line is missing the $for/$ keyword', ...
            'The first line is missing the loop variable $ii/$', ...
            'This code defines $ii/$ incorrectly with $==/$', ...
            'This code is missing the $end/$ keyword', ...
            'This code does not define any values to the loop variable $ii/$', ...
            'This code is missing a statement inside the loop that prints out a value', ...
            'This code prints out too few values', ...
            'This code uses brackets to enclose the loop statements', ...
            'This code defines $ii/$ incorrectly with the word $in/$', ...
            'This code defines $ii/$ incorrectly with $</$'};
